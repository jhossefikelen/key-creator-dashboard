...
export const Route = createFileRoute("/painel")({
  head: () => ({
    meta: [
      { title: "KEYGEN // Painel de Licenças" },
      {
        name: "description",
        content:
          "Gere, revogue e acompanhe chaves de licença com validade e limite de ativações.",
      },
      { property: "og:title", content: "KEYGEN // Painel de Licenças" },
      {
        property: "og:description",
        content: "Gere, revogue e acompanhe chaves de licença em um painel único.",
      },
      ...
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-border pb-6">
        <div>
          <h1 className="text-glow flex items-center gap-2 text-2xl font-bold text-primary">
            <KeyRound className="size-6" /> PAINEL DE LICENÇAS
          </h1>
